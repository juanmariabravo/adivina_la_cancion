...
class SpotifyHelper:
    ...
    def get_track_info(self, spotify_track_id: str, access_token: str) -> Optional[dict]:
        """
        Obtener información de un track de Spotify por su ID
        """
        try:
            headers = {'Authorization': f'Bearer {access_token}'}
            response = requests.get(f'{self.api_url}/tracks/{spotify_track_id}', headers=headers)
